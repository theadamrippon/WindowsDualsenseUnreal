 ...
 * 
 */
class WINDOWSDUALSENSE_DS5W_API DualSenseInputDevice final : public IInputDevice, public IHapticDevice
{
public:
	explicit DualSenseInputDevice(const TSharedRef<FGenericApplicationMessageHandler>& InMessageHandler, bool Lazily);
	virtual ~DualSenseInputDevice() override;
